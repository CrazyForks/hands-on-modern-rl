...
The reward only takes values 0 and 1—no intermediate states. This is the **RLVR (Reinforcement Learning with Verifiable Rewards)** discussed in Chapter 16: code is either correct or incorrect; no Reward Model guesswork needed.
...
GRPO's training loop (corresponds to the algorithm in Chapter 16):
