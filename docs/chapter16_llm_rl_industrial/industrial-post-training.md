...
不同公司会使用不同算法名称，但一轮后训练都可以放回这六个阶段。先沿着代码修复任务走一遍，再看公开方案怎样扩展这条流程。
...
### 4.1 面壁智能 MiniCPM5：领域专家 RL 与 OPD 能力合并
...
接下来的公司标题只表示资料来源。每个小节开头的“动机、数据、奖励、评测或最小复现”对应六阶段中的具体位置。
