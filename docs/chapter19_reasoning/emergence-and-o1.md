...
这种范式后来被定义为 **agentic reasoning**——推理不再是单次前向的 CoT，而是与外部环境交互的多步过程。这与 [第 19 章 Agentic RL](../chapter22_agentic/overview) 的内容深度交叉。

## 16.1.2 Competitive Programming 论文 与 涌现的关键证据
